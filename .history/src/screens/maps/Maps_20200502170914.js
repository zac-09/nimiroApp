...
import { StyleSheet, Platform, Text, Dimensions, TouchableWithoutFeedback } from 'react-native';
    ...
    render(){
        ...
        return(
            <View style={styles.container}>
                ...
                {!showDetais && <View style={styles.addContainer}>
                ...
                {showDetais &&  details &&
                    ...
                    >
                        <View>
                            ...
                            {!canceled && <Text style={styles.dates}><Text style={styles.label}>Starting date: </Text>{`${formatDate(details.starting_date.toDate())}`}</Text>}
                            {!canceled && <Text style={styles.dates}><Text style={styles.label}>End date: </Text>{`${formatDate(details.end_date.toDate())}`}</Text>}
                            {canceled && <Text style={styles.dates}><Text style={styles.label}>Status: </Text>Cancelled</Text>}
                        </View>
